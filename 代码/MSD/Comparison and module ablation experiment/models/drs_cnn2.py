...
class SCRE_Unit(nn.Module):
    """Separable Convolution Residual Encoder Unit"""
...
class SCRD_Unit(nn.Module):
    """Separable Convolution Residual Decoder Unit"""
...
class ASC_Unit(nn.Module):
    """Atrous Separable Convolution Unit"""
